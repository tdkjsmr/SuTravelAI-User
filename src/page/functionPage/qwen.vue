<template> 
  <div class="content">
    ...
    />
      ...
      <introParagraphQwen></introParagraphQwen>
      <defaultQuestionQwen></defaultQuestionQwen>
      <chatMessage></chatMessage>
      
      
  </div >
  <inputAreaQwen></inputAreaQwen>
   <div style="height: 300px;" class="zhanwei"></div>
  
  </template>
  
  <script setup lang="ts">
  import introParagraphQwen from "@/page/component/introParagraphQwen.vue";
  import defaultQuestionQwen from "@/page/component/defaultQuestionQwen.vue";
  import chatMessage from "@/page/component/chatMessage.vue";
  import inputAreaQwen from "@/page/component/inputAreaQwen.vue";
  //监听滚动页面
  ...
  .content{
      padding:0 15px;
      background-image: url('@/assets/background/绘制点染水墨画.png'); /* 使用 @ 别名指向 src 目录 */
