<template>
    ...
    <div class="weather-content">
        <div class="weather-item" v-for="(item,index) in functionData" :key="index">
            ...
            <div class="day-temperature">{{item.night_air_temperature}}~{{item.day_air_temperature}}℃</div>
        </div>
    </div>
</template>

<script setup lang="ts">
import { serverWeatherType } from "@/types/index";
defineProps<{
    functionData:serverWeatherType
}>()
</script>
